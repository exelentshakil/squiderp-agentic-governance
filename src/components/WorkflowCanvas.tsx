...
export function WorkflowCanvas() {
  ...
  const nodes = [
    ...
    {
      id: 6,
      title: "06. Human Sign-Off",
      subtitle: "Staff Architect Gate",
      badge: "One-Click",
      icon: Users,
      tech: "Ledger Guard",
  ...
  return (
    <div className="w-full rounded-xl border border-slate-200 bg-white dark:border-slate-800 dark:bg-slate-900 shadow-sm p-4 sm:p-5 mb-6">
      ...
      <div className="relative">
        {/* Animated Connector Wire (Desktop) */}
        <div className="hidden lg:block absolute top-[52px] left-[6%] right-[6%] h-[2px] z-0">
          ...
          {nodes.map((n, idx) => {
            ...
            return (
              ...
              >
                ...
                <div className="pt-2 border-t border-slate-200/60 dark:border-slate-800 flex items-center justify-between text-xs font-mono text-slate-500 dark:text-slate-400">
                  <span className="truncate">{n.tech}</span>
